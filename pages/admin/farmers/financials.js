...
<div className="ti-modal-header">
      <h6 className="modal-title" id="staticBackdropLabel2">Farmer Details
      </h6>
...
<div className="ti-modal-body">
      <div className="grid grid-cols-12 gap-2">
          ...
          <div className="xl:col-span-6 col-span-12">
          <label htmlFor="task-name" className="form-label">Farm Address</label>
          ...
          <input type="text" className="form-control" id="task-name" placeholder="Enter Latitude" />
          </div>

          <div className="xl:col-span-6 col-span-12">
          <label htmlFor="task-name" className="form-label">GPS Longitude</label>
          <input type="text" className="form-control" id="task-name" placeholder="Enter Longitude" />
          </div>
...
<th scope="col" className="text-start">GRN #</th>
...
<th scope="col" className="text-start">Total Amount Payable</th>
<th scope="col" className="text-start">Amount Paid</th>
<th scope="col" className="text-start">Balance Amount</th>
<th scope="col" className="text-start">Payment Status</th>
<th scope="col" className="text-start">GRN Status</th>
<th scope="col" className="text-start">View</th>
<th scope="col" className="text-start">Add Payment</th>
...
<tr className="border border-defaultborder task-list">
  ...
  <td>
  <span className="font-semibold">GRN24010001</span>
  </td>
  ...
  <td>
  <span className="font-semibold">PRBUINA00086</span>
  </td>
...
<td><span className="badge bg-secondary text-white">Not Paid</span> 
</td>
...
<td>
<div className="hs-tooltip ti-main-tooltip">
<button type="button" className="hs-tooltip-toggle ti-btn ti-btn-secondary ti-btn-sm" data-hs-overlay="#make_paymentmodal">
...
<td>
<span className="font-semibold">GRN24010002</span>
</td>
<td>
<span className="font-semibold">Charan Palimara</span>
</td>
<td>
<span className="font-semibold">PRBUINA00038</span>
</td>
<td>
<span className="font-semibold">Tomato</span>
</td>
...
<td>
<span className="font-semibold">1500 kg</span>
</td>
<td>
...
<td>
<span className="font-semibold">GRN24010003</span>
</td>
<td>
<span className="font-semibold">Mahesh Manchala</span>
</td>
<td>
<span className="font-semibold">PRBUINA00058</span>
</td>
<td>
<span className="font-semibold">Tomato</span>
</td>
...
<td><span className="badge bg-success text-white">Paid Off</span> 
</td>
<td><span className="badge bg-primary text-white">Pending</span></td>
...
<td>
<span className="font-semibold">GRN24010004</span>
</td>
<td>
<span className="font-semibold">Sathish Kumar</span>
</td>
<td>
<span className="font-semibold">PRBUINA00099</span>
</td>
<td>
<span className="font-semibold">Tomato</span>
</td>
...
<td>
<span className="font-semibold">GRN24010005</span>
</td>
<td>
<span className="font-semibold">Dhanush Chandra</span>
</td>
<td>
<span className="font-semibold">PRBUINA00066</span>
</td>
<td>
<span className="font-semibold">Tomato</span>
</td>
...
<td><span className="badge bg-success text-white">Pending</span></td>
