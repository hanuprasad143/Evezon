...
<div className="flex">
<button type="button" className="hs-dropdown-toggle ti-btn ti-btn-primary-full !py-1 !px-2 !text-[0.75rem]" data-hs-overlay="#add_products">
...
<thead>
    <tr>
        ...
        <th scope="col" className="text-start">HSN Code</th>
        <th scope="col" className="text-start">Product Image</th>
        <th scope="col" className="text-start">No Of Table Grade</th>
        <th scope="col" className="text-start">No Of Process Grade</th>
        <th scope="col" className="text-start">No Of Variants</th>
...
<tbody>
    <tr className="border border-defaultborder task-list">
        ...
        <td>
            <span className="font-semibold">1633</span>
        </td>
        <td>
        ...
        <td>
            ...
            <button type="button" className="hs-tooltip-toggle ti-btn ti-btn-secondary ti-btn-sm" data-hs-overlay="#view_products">
        ...
        <td>
            <div className="hs-tooltip ti-main-tooltip">
                <button type="button" className="hs-tooltip-toggle ti-btn ti-btn-primary ti-btn-sm"  data-hs-overlay="#edit_products">
            ...
            <div className="hs-tooltip ti-main-tooltip">
                <button type="button" className="hs-tooltip-toggle ti-btn ti-btn-danger ms-1 ti-btn-sm task-delete-btn"  data-hs-overlay="#delete_products">
    ...
    <tr className="border border-defaultborder task-list">
        ...
        <td>
            <span className="font-semibold">7133</span>
        </td>
        <td>
        <span className="avatar avatar-sm avatar-rounded">
    ...
    <tr className="border border-defaultborder task-list">
        ...
        <td>
            <span className="font-semibold">3255</span>
        </td>
        <td>
        <span className="avatar avatar-sm avatar-rounded">
    ...
    <tr className="border border-defaultborder task-list">
        ...
        <td>
            <span className="font-semibold">7167</span>
        </td>
        <td>
        <span className="avatar avatar-sm avatar-rounded">
