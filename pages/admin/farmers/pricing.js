...
<div className="flex">
<button type="button" className="hs-dropdown-toggle ti-btn ti-btn-primary-full !py-1 !px-2 !text-[0.75rem]" data-hs-overlay="#add_pricing">
<i className="ri-add-line font-semibold align-middle"></i>New Pricing
</button>
        ...
        <tbody>
            <tr className="border border-defaultborder task-list">
                ...
                <td>
                    ...
                    <button type="button" className="hs-tooltip-toggle ti-btn ti-btn-secondary ti-btn-sm" data-hs-overlay="#view_pricing">
                ...
                <td>
                    <div className="hs-tooltip ti-main-tooltip">
                        <button type="button" className="hs-tooltip-toggle ti-btn ti-btn-primary ti-btn-sm" data-hs-overlay="#edit_pricing">
                    ...
                    <div className="hs-tooltip ti-main-tooltip">
                        <button type="button" className="hs-tooltip-toggle ti-btn ti-btn-danger ms-1 ti-btn-sm task-delete-btn" data-hs-overlay="#delete_pricing">
            ...
            <tr className="border border-defaultborder task-list">
                ...
                <td>
                 ...
                 <td>
                    <span className="font-semibold">Tomoato</span>
                </td>
                <td>
                    <span className="font-semibold">Tomato Local</span>
                </td>
                ...
                <td>
                     <span className="font-semibold">Jan 8,2024</span>
                </td>
                        <td>
                    <div className="hs-tooltip ti-main-tooltip">
                    <button type="button" className="hs-tooltip-toggle ti-btn ti-btn-secondary ti-btn-sm" data-hs-overlay="#view_pricingr">
                    <i className="ri-eye-fill"></i>
                    <span
                    className="hs-tooltip-content  ti-main-tooltip-content py-1 px-2 !bg-black !text-xs !font-medium !text-white shadow-sm "
                    role="tooltip">
            ...
            <tr className="border border-defaultborder task-list">
                ...
                <td>
                    <span className="font-semibold">Assam</span>
                </td>
                 <td>
                    <span className="font-semibold">Potatao</span>
                </td>
                <td>
                ...
                <td>
                     <span className="font-semibold">Jan 21,2024</span>
                </td>
                        <td>
                    <div className="hs-tooltip ti-main-tooltip">
                    <button type="button" className="hs-tooltip-toggle ti-btn ti-btn-secondary ti-btn-sm" data-hs-overlay="#view_pricing">
            ...
            <tr className="border border-defaultborder task-list">
                ...
                <td>
                    <span className="font-semibold">Bihar</span>
                </td>
                 <td>
                    <span className="font-semibold">Brinjal</span>
                </td>
                ...
                <td>
                     <span className="font-semibold">Jan 6,2024</span>
                </td>
                        <td>
                    <div className="hs-tooltip ti-main-tooltip">
                    <button type="button" className="hs-tooltip-toggle ti-btn ti-btn-secondary ti-btn-sm" data-hs-overlay="#view_pricing">
            ...
            <tr className="border border-defaultborder task-list">
                ...
                <td>
                    <span className="font-semibold">Chattishgarh</span>
                </td>
                 <td>
                    <span className="font-semibold">Cabbage</span>
                </td>
                <td>
                    <span className="font-semibold">Cabbage Local</span>
                </td>
                <td>
                    <span className="font-semibold">Medium</span>
                </td>
