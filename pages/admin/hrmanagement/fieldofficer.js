                    ...
                    <div className="box custom-box border-t-[0.188rem] border-solid !border-t-primary !rounded-none">
                        <div className="box-body">
                            <div className="text-center">
                                ...
                                <p className="text-[.875rem] font-semibold mb-2">Total Field Officers</p>
...
<i className="ri-add-line font-semibold align-middle"></i> Create Field Officer
</button>
...
<th scope="col" className="text-start">Field Officer Id</th>
...
<tr className="border border-defaultborder task-list">
                ...
                <td>
                    <span className="font-semibold">EVFO0001</span>
                </td>
                <td>
...
<td>
<span className="font-semibold">EVFO0002</span>
</td>
<td>
...
<td>
<span className="font-semibold">EVFO0003</span>
</td>
<td>
...
<td>
<span className="font-semibold">EVFO0004</span>
</td>
<td>
...
<td>
<span className="font-semibold">EVFO0005</span>
</td>
<td>
...
<h6 className="modal-title" id="staticBackdropLabel2">View Field Officer Details
</h6>
...
<input type="text" className="form-control" id="task-name" value="Field Officer Id" />
</div>
<div className="xl:col-span-6 col-span-12">
...
<div className="ti-modal-content">
<div className="ti-modal-header">
<h6 className="modal-title" id="staticBackdropLabel2">Edit Field Officer Details
</h6>
...
<div className="ti-modal-content">
<div className="ti-modal-header">
<h6 className="modal-title" id="staticBackdropLabel2">Field Officer Details
</h6>
...
<div className="xl:col-span-6 col-span-12">
<label htmlFor="task-name" className="form-label">Field Officer Id</label>
<input type="text" className="form-control" id="task-name" placeholder="Enter Field Officer Id" />
</div>
