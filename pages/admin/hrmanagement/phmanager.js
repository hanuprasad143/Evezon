              ...
              <div className="box custom-box border-t-[0.188rem] border-solid !border-t-primary !rounded-none">
                  <div className="box-body">
                      <div className="text-center">
                          ...
                          <p className="text-[.875rem] font-semibold mb-2">Total Pack House Managers</p>
...
<i className="ri-add-line font-semibold align-middle"></i> Create Pack House Manager
</button>
...
<h6 className="modal-title" id="staticBackdropLabel2">Pack House Manager Details
</h6>
...
<td>
<span className="font-semibold">EVPHMG0001</span>
</td>
<td>
...
<td>
<span className="font-semibold">EVPHMG0002</span>
</td>
<td>
...
<td>
<span className="font-semibold">EVPHMG0003</span>
</td>
<td>
...
<td>
<span className="font-semibold">EVPHMG0004</span>
</td>
<td>
...
<td>
<span className="font-semibold">EVPHMG0005</span>
</td>
<td>
...
<div className="ti-modal-content">
<div className="ti-modal-header">
<h6 className="modal-title" id="staticBackdropLabel2">View Pack House Manager Details
</h6>
