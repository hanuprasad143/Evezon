               ...
               <div className="box custom-box border-t-[0.188rem] border-solid !border-t-primary !rounded-none"> 
                   <div className="box-body"> 
                       <div className="text-center"> 
                           ...
                           <p className="text-[.875rem] font-semibold mb-2">Total Warehouse Employees</p> 
...
<i className="ri-add-line font-semibold align-middle"></i> Create Ware House Employee
</button>
...
<h6 className="modal-title" id="staticBackdropLabel2">Ware House Employee Details
</h6>
...
<td>
<span className="font-semibold">EVWHE0001</span>
</td>
<td>
...
<td>
<span className="font-semibold">EVWHE0002</span>
</td>
<td>
...
<td>
<span className="font-semibold">EVWHE0003</span>
</td>
<td>
...
<td>
<span className="font-semibold">EVWHE0004</span>
</td>
<td>
...
<td>
<span className="font-semibold">EVWHE0005</span>
</td>
<td>
...
<div className="ti-modal-content">
<div className="ti-modal-header">
<h6 className="modal-title" id="staticBackdropLabel2">View Ware House Employee Details
</h6>
...
<div className="ti-modal-content">
<div className="ti-modal-header">
<h6 className="modal-title" id="staticBackdropLabel2">Edit Ware House Employee Details
</h6>
