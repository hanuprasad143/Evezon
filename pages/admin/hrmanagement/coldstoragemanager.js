              ...
              <div className="box custom-box border-t-[0.188rem] border-solid !border-t-primary !rounded-none">
                  <div className="box-body">
                      <div className="text-center">
                          ...
                          <p className="text-[.875rem] font-semibold mb-2">Total Cold Storage Managers</p>
...
<i className="ri-add-line font-semibold align-middle"></i> Create Cold Storage Manager
</button>
...
<h6 className="modal-title" id="staticBackdropLabel2">Cold Storage Manager Details
</h6>
...
<input type="text" className="form-control" id="task-name" placeholder="Enter Manager id" />
</div>
...
<th scope="col" className="text-start">Manager id</th>
...
<td>
<span className="font-semibold">EVCSM0001</span>
</td>
<td>
...
<td>
<span className="font-semibold">EVCSM0002</span>
</td>
<td>
...
<td>
<span className="font-semibold">EVCSM0003</span>
</td>
<td>
...
<td>
<span className="font-semibold">EVCSM0004</span>
</td>
<td>
...
<td>
<span className="font-semibold">EVCSM0005</span>
</td>
<td>
...
<div className="ti-modal-content">
<div className="ti-modal-header">
<h6 className="modal-title" id="staticBackdropLabel2">View Cold Storage Manager Details
</h6>
...
<div className="ti-modal-content">
<div className="ti-modal-header">
<h6 className="modal-title" id="staticBackdropLabel2">Edit Cold Storage Manager Details
</h6>
