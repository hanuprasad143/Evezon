              ...
              <div className="box custom-box border-t-[0.188rem] border-solid !border-t-primary !rounded-none">
                  <div className="box-body">
                      <div className="text-center">
                          ...
                          <p className="text-[.875rem] font-semibold mb-2">Total Marketing Officers</p>
...
<i className="ri-add-line font-semibold align-middle"></i> Create Marketing Officer
</button>
...
<h6 className="modal-title" id="staticBackdropLabel2">Marketing Officer Details
</h6>
...
<td>
<span className="font-semibold">EVMO0001</span>
</td>
<td>
...
<td>
<span className="font-semibold">EVMO0002</span>
</td>
<td>
...
<td>
<span className="font-semibold">EVMO0003</span>
</td>
<td>
...
<td>
<span className="font-semibold">EVMO0004</span>
</td>
<td>
...
<td>
<span className="font-semibold">EVMO0005</span>
</td>
<td>
...
<div className="ti-modal-content">
<div className="ti-modal-header">
<h6 className="modal-title" id="staticBackdropLabel2">View Marketing Officer Details
</h6>
...
<div className="ti-modal-content">
<div className="ti-modal-header">
<h6 className="modal-title" id="staticBackdropLabel2">Edit Marketing Officer Details
</h6>
