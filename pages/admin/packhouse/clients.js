...
const SelectState = [
  ...
  const SelectPackhouse = [
    { value: "packhouse1", label: "packhouse1" },
    { value: "packhouse2", label: "packhouse2" },
    { value: "packhouse3", label: "packhouse3" } 
  ];
...
<div className="xxl:col-span-12 xl:col-span-12 md:col-span-12 col-span-12">
    ...
    <button type="button" className="hs-dropdown-toggle ti-btn ti-btn-primary-full !py-1 !px-2 !text-[0.75rem]" data-hs-overlay="#add_clients">
    <i className="ri-add-line font-semibold align-middle"></i>New Clients
    </button>
        ...
        <table className="table whitespace-nowrap table-bordered min-w-full">
            <thead>
                <tr>
                    ...
                    <th scope="col" className="text-start">Packhouse </th>
                    <th scope="col" className="text-start">Company ID</th>
                    <th scope="col" className="text-start">Company Name </th>
                    <th scope="col" className="text-start">Client Name  </th>
            ...
            <tbody>
                <tr className="border border-defaultborder task-list">
                    ...
                    <td>
                        <span className="font-semibold">Evezon Packhouse</span>
                    </td>
                    <td>
                        <span className="font-semibold">BUINKA00019</span>
                    </td>
                    
                     <td>
                        <span className="font-semibold">BILLION RETAIL SERVICES</span>
                    </td>
                    <td>
                        <span className="font-semibold">Sabhareesh</span>
                    </td>
                    <td>
                        <span className="font-semibold">(900) 080 2076</span>
                    </td>
                    <td>
                        <span className="font-semibold">sheshadri173@gmail.com</span>
                    </td>
                    <td>
                        <span className="font-semibold">Bangalore Urban</span>
                    </td>
                    <td>
                   ...
                   <td>
                        ...
                        <button type="button" className="hs-tooltip-toggle ti-btn ti-btn-secondary ti-btn-sm" data-hs-overlay="#view_clients">
                     ...
                     <td>
                        <div className="hs-tooltip ti-main-tooltip">
                            <button type="button" className="hs-tooltip-toggle ti-btn ti-btn-primary ti-btn-sm" data-hs-overlay="#edit_clients" >
                        ...
                        <div className="hs-tooltip ti-main-tooltip">
                            <button type="button" className="hs-tooltip-toggle ti-btn ti-btn-danger ms-1 ti-btn-sm task-delete-btn" data-hs-overlay="#delete_clients">
                ...
                <tr className="border border-defaultborder task-list">
                    ...
                    <td>
                        <span className="font-semibold">BUINKA00018</span>
                    </td>
                    
                     <td>
                        <span className="font-semibold">LoGoJeCh</span>
                    </td>
                    <td>
                    ...
                    <td>
                        <span className="font-semibold">abhi173@gmail.com</span>
                    </td>
                    <td>
                        <span className="font-semibold">Bangalore Urban</span>
                    </td>
                ...
                <tr className="border border-defaultborder task-list">
                    ...
                    <td>
                    <span className="badge bg-primary text-white">On-Hold</span> 
                    </td>
...
{/* add code starts */ }
<div id="add_clients" className="hs-overlay hidden ti-modal">
<div className="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out min-h-[calc(100%-3.5rem)] flex items-center">
<div className="ti-modal-content">
<div className="ti-modal-header">
<h6 className="modal-title" id="staticBackdropLabel2">Client Details
</h6>
<button type="button" className="hs-dropdown-toggle ti-modal-close-btn" data-hs-overlay="#add_clients">
<span className="sr-only">Close</span>
<svg className="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0.258206 1.00652C0.351976 0.912791 0.479126 0.860131 0.611706 0.860131C0.744296 0.860131 0.871447 0.912791 0.965207 1.00652L3.61171 3.65302L6.25822 1.00652C6.30432 0.958771 6.35952 0.920671 6.42052 0.894471C6.48152 0.868271 6.54712 0.854471 6.61352 0.853901C6.67992 0.853321 6.74572 0.865971 6.80722 0.891111C6.86862 0.916251 6.92442 0.953381 6.97142 1.00032C7.01832 1.04727 7.05552 1.1031 7.08062 1.16454C7.10572 1.22599 7.11842 1.29183 7.11782 1.35822C7.11722 1.42461 7.10342 1.49022 7.07722 1.55122C7.05102 1.61222 7.01292 1.6674 6.96522 1.71352L4.31871 4.36002L6.96522 7.00648C7.05632 7.10078 7.10672 7.22708 7.10552 7.35818C7.10442 7.48928 7.05182 7.61468 6.95912 7.70738C6.86642 7.80018 6.74102 7.85268 6.60992 7.85388C6.47882 7.85498 6.35252 7.80458 6.25822 7.71348L3.61171 5.06702L0.965207 7.71348C0.870907 7.80458 0.744606 7.85498 0.613506 7.85388C0.482406 7.85268 0.357007 7.80018 0.264297 7.70738C0.171597 7.61468 0.119017 7.48928 0.117877 7.35818C0.116737 7.22708 0.167126 7.10078 0.258206 7.00648L2.90471 4.36002L0.258206 1.71352C0.164476 1.61976 0.111816 1.4926 0.111816 1.36002C0.111816 1.22744 0.164476 1.10028 0.258206 1.00652Z" fill="currentColor" />
</svg>
...
<div className="hs-accordion active overflow-hidden bg-white dark:bg-bodybg border -mt-px first:rounded-t-sm last:rounded-b-sm dark:bg-bgdark dark:border-white/10" id="hs-accordion-heading-1">
                    <button
                      ...
                      aria-labelledby="hs-accordion-heading-1">
                               ...
                               <label htmlFor="task-name" className="form-label">Pack House</label>
                              <Select classNamePrefix='Select2' className="ti-form-select rounded-sm !p-0" multi options={SelectPackhouse} />
                               ...
                               <div className="xl:col-span-6 col-span-12">
                                ...
                                <label htmlFor="task-name" className="form-label">Type</label>
                                <Select classNamePrefix='Select2' className="ti-form-select rounded-sm !p-0" multi options={SelectType} />
                                                                            
                                </div>
                                                                   

                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">Company name</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter Company name" />
                                </div>


                                <div className="xl:col-span-6 col-span-12">
                                                                                                   
                                <label htmlFor="task-name" className="form-label">Type Of The Company</label>
                                <Select classNamePrefix='Select2' className="ti-form-select rounded-sm !p-0" multi options={SelectTypeofCompany} />
                                                                            
                                </div>

                                <div className="xl:col-span-6 col-span-12">
                                                                                                   
                                <label htmlFor="task-name" className="form-label">Supplier Agreement Signed</label>
                                <Select classNamePrefix='Select2' className="ti-form-select rounded-sm !p-0" multi options={SelectSupplierAgreement} />
                                                                            
                                </div>


                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">PAN#</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter PAN" />
                                </div>


                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">COI</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter COI" />
                                </div>


                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">GSTIN</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter GSTIN" />
                                </div>


                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">FSSAI</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter FSSAI" />
                                </div>


                                <div className="xl:col-span-6 col-span-12 product-documents-container">
                                 <p className="font-semibold mb-2 text-[0.875rem]">Upload Documents :</p>
                                ...
                                {/* put form or table here*/}

                                </div>

                    </div>

                      {/* actual form block endsn */}
...
{/* each tab code block 1 ends */}



{/* each tab code block2 starts */}
...
<div className="hs-accordion overflow-hidden bg-white dark:bg-bodybg border -mt-px first:rounded-t-sm last:rounded-b-sm dark:bg-bgdark dark:border-white/10" id="hs-accordion-heading-2">
                    <button
                      ...
                      aria-labelledby="hs-accordion-heading-2">
                                ...
                                {/* <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">Package Id</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter Package List Id" />
                                </div> */}
                                ...
                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label"> Designation</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter Designation" />
                                </div>


                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label"> Phone Number</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter Phone Number" />
                                </div>


                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label"> Email ID</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter Email.ID" />
                                </div>
...
{/* each tab code block2 ends */}



{/* each tab code block3 starts */}
...
{/* each tab code block3 ends */}



{/* each tab code block4 starts */}

<div className="hs-accordion overflow-hidden bg-white dark:bg-bodybg border -mt-px first:rounded-t-sm last:rounded-b-sm dark:bg-bgdark dark:border-white/10" id="hs-accordion-heading-4">
                    <button
                        className="hs-accordion-toggle hs-accordion-active:text-primary hs-accordion-active:bg-primary/10 group py-4 px-5 inline-flex items-center justify-between gap-x-3 w-full font-semibold text-start text-gray-800 transition hover:text-gray-500 dark:hs-accordion-active:text-primary dark:text-gray-200 dark:hover:text-white/80"
                        aria-controls="hs-accordion-collapse-1" type="button">
                        Billing Address
                      ...
                      aria-labelledby="hs-accordion-heading-4">
                                ...
                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">Google auto fill address</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter Google auto fill address" />
                                </div>


                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">Address1</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter Address1" />
                                </div>


                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">Address2</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter Address2" />
                                </div>
                                ...
                                <Select classNamePrefix='Select2' className="ti-form-select rounded-sm !p-0" multi options={SelectDistrict} />
                                ...
                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">Pin</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter Pin" />
                                </div>                           
...
{/* each tab code block4 ends */}



<div className="ti-modal-footer">
<button type="button" className="hs-dropdown-toggle ti-btn ti-btn-light" data-hs-overlay="#add_clients">
Cancel
</button>
<Link className="ti-btn ti-btn-primary-full" href="#!">
Submit
...
<div id="view_clients" className="hs-overlay hidden ti-modal">
<div className="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out min-h-[calc(100%-3.5rem)] flex items-center">
<div className="ti-modal-content">
<div className="ti-modal-header">
<h6 className="modal-title" id="staticBackdropLabel2">Client Details
</h6>
<button type="button" className="hs-dropdown-toggle ti-modal-close-btn" data-hs-overlay="#view_clients">
<span className="sr-only">Close</span>
<svg className="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0.258206 1.00652C0.351976 0.912791 0.479126 0.860131 0.611706 0.860131C0.744296 0.860131 0.871447 0.912791 0.965207 1.00652L3.61171 3.65302L6.25822 1.00652C6.30432 0.958771 6.35952 0.920671 6.42052 0.894471C6.48152 0.868271 6.54712 0.854471 6.61352 0.853901C6.67992 0.853321 6.74572 0.865971 6.80722 0.891111C6.86862 0.916251 6.92442 0.953381 6.97142 1.00032C7.01832 1.04727 7.05552 1.1031 7.08062 1.16454C7.10572 1.22599 7.11842 1.29183 7.11782 1.35822C7.11722 1.42461 7.10342 1.49022 7.07722 1.55122C7.05102 1.61222 7.01292 1.6674 6.96522 1.71352L4.31871 4.36002L6.96522 7.00648C7.05632 7.10078 7.10672 7.22708 7.10552 7.35818C7.10442 7.48928 7.05182 7.61468 6.95912 7.70738C6.86642 7.80018 6.74102 7.85268 6.60992 7.85388C6.47882 7.85498 6.35252 7.80458 6.25822 7.71348L3.61171 5.06702L0.965207 7.71348C0.870907 7.80458 0.744606 7.85498 0.613506 7.85388C0.482406 7.85268 0.357007 7.80018 0.264297 7.70738C0.171597 7.61468 0.119017 7.48928 0.117877 7.35818C0.116737 7.22708 0.167126 7.10078 0.258206 7.00648L2.90471 4.36002L0.258206 1.71352C0.164476 1.61976 0.111816 1.4926 0.111816 1.36002C0.111816 1.22744 0.164476 1.10028 0.258206 1.00652Z" fill="currentColor" />
</svg>
...
<div className="hs-accordion active overflow-hidden bg-white dark:bg-bodybg border -mt-px first:rounded-t-sm last:rounded-b-sm dark:bg-bgdark dark:border-white/10" id="hs-accordion-heading-1">
                    <button
                      ...
                      aria-labelledby="hs-accordion-heading-1">
                                ...
                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">Pack House</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter Company name" value="Pack House 1" />
                                </div>

                               
                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">Type</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter Company name" value="Buyer" />
                                </div>
                                                                   

                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">Company name</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter Company name" value="LoGoJeCh" />
                                </div>

                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">Type Of The Company</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter Company name" value="Private Limited" />
                                </div>
                                ...
                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">Supplier Agreement Signed</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter Company name" value="Yes" />
                                </div>


                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">PAN#</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter PAN" value="1234568912" />
                                </div>


                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">COI</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter COI" value="6523352" />
                                </div>


                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">GSTIN</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter GSTIN" value="12851563" />
                                </div>


                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">FSSAI</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter FSSAI" value="9562313" />
                                </div>


                                <div className="xl:col-span-6 col-span-12">
                                  <label htmlFor="task-name" className="form-label">Document Photo</label>
                                  <img src="../../../assets/images/idproofs/phmanager/1.jpeg" alt="img" />
                                  </div>
...
<div className="hs-accordion overflow-hidden bg-white dark:bg-bodybg border -mt-px first:rounded-t-sm last:rounded-b-sm dark:bg-bgdark dark:border-white/10" id="hs-accordion-heading-2">
                    <button
                      ...
                      aria-labelledby="hs-accordion-heading-2">
                                ...
                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">First Name</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter First Name" value="Bhanu" />
                                </div>


                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label"> Last Name</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter Last Name" value="Arun" />
                                </div>


                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label"> Designation</label>
                                <input type="text" className="form-control" id="task-name" placeholder="Enter Designation" value="Engineer" />
                                </div>


                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label"> Phone Number</label>
                                <input type="text" className="form-control" id="task-name" value="9875641230" />
                                </div>


                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label"> Email ID</label>
                                <input type="text" className="form-control" id="task-name" value="abhi@gmail.com" />
                                </div>
...
<div className="hs-accordion overflow-hidden bg-white dark:bg-bodybg border -mt-px first:rounded-t-sm last:rounded-b-sm dark:bg-bgdark dark:border-white/10" id="hs-accordion-heading-3">
                    <button
                      ...
                      aria-labelledby="hs-accordion-heading-3">
                                ...
                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">First Name</label>
                                <input type="text" className="form-control" id="task-name" value="Abhinav" />
                                </div>


                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">Last Name</label>
                                <input type="text" className="form-control" id="task-name" value="Nunna" />
                                </div>


                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">Designation</label>
                                <input type="text" className="form-control" id="task-name" value="Developer" />
                                </div>


                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label"> Phone Number</label>
                                <input type="text" className="form-control" id="task-name" value="654512318" />
                                </div>
...
<div className="hs-accordion overflow-hidden bg-white dark:bg-bodybg border -mt-px first:rounded-t-sm last:rounded-b-sm dark:bg-bgdark dark:border-white/10" id="hs-accordion-heading-4">
                    <button
                      ...
                      aria-labelledby="hs-accordion-heading-4">
                                ...
                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">Google auto fill address</label>
                                <input type="text" className="form-control" id="task-name" value="Akkayapalem" />
                                </div>


                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">Address1</label>
                                <input type="text" className="form-control" id="task-name" value="1-45" />
                                </div>


                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">Address2</label>
                                <input type="text" className="form-control" id="task-name" value="Visakhapatnam" />
                                </div>
                                ...
                                <div className="xl:col-span-6 col-span-12">
                                <label htmlFor="task-name" className="form-label">Pin Code</label>
                                <input type="text" className="form-control" id="task-name" value="530003" />
                                </div>                           
...
<div className="ti-modal-footer">
<button type="button" className="hs-dropdown-toggle ti-btn ti-btn-light" data-hs-overlay="#view_clients">
Cancel
</button>
<Link className="ti-btn ti-btn-primary-full" href="#!">
Submit
...
<div id="edit_clients" className="hs-overlay hidden ti-modal">
<div className="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out min-h-[calc(100%-3.5rem)] flex items-center">
<div className="ti-modal-content">
<div className="ti-modal-header">
<h6 className="modal-title" id="staticBackdropLabel2">Client Details
</h6>
<button type="button" className="hs-dropdown-toggle ti-modal-close-btn" data-hs-overlay="#edit_clients">
<span className="sr-only">Close</span>
<svg className="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0.258206 1.00652C0.351976 0.912791 0.479126 0.860131 0.611706 0.860131C0.744296 0.860131 0.871447 0.912791 0.965207 1.00652L3.61171 3.65302L6.25822 1.00652C6.30432 0.958771 6.35952 0.920671 6.42052 0.894471C6.48152 0.868271 6.54712 0.854471 6.61352 0.853901C6.67992 0.853321 6.74572 0.865971 6.80722 0.891111C6.86862 0.916251 6.92442 0.953381 6.97142 1.00032C7.01832 1.04727 7.05552 1.1031 7.08062 1.16454C7.10572 1.22599 7.11842 1.29183 7.11782 1.35822C7.11722 1.42461 7.10342 1.49022 7.07722 1.55122C7.05102 1.61222 7.01292 1.6674 6.96522 1.71352L4.31871 4.36002L6.96522 7.00648C7.05632 7.10078 7.10672 7.22708 7.10552 7.35818C7.10442 7.48928 7.05182 7.61468 6.95912 7.70738C6.86642 7.80018 6.74102 7.85268 6.60992 7.85388C6.47882 7.85498 6.35252 7.80458 6.25822 7.71348L3.61171 5.06702L0.965207 7.71348C0.870907 7.80458 0.744606 7.85498 0.613506 7.85388C0.482406 7.85268 0.357007 7.80018 0.264297 7.70738C0.171597 7.61468 0.119017 7.48928 0.117877 7.35818C0.116737 7.22708 0.167126 7.10078 0.258206 7.00648L2.90471 4.36002L0.258206 1.71352C0.164476 1.61976 0.111816 1.4926 0.111816 1.36002C0.111816 1.22744 0.164476 1.10028 0.258206 1.00652Z" fill="currentColor" />
</svg>
...
<div className="ti-modal-footer">
<button type="button" className="hs-dropdown-toggle ti-btn ti-btn-light" data-hs-overlay="#edit_clients">
Cancel
</button>
<Link className="ti-btn ti-btn-primary-full" href="#!">
Submit
