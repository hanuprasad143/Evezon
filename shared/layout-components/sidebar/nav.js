...
const Partners = <i className="bx bxs-group side-menu__icon"></i>;
...
const HomeMenuIcon = <i className="bx bx-home side-menu__icon"></i>;

const MasterDataMenuIcon = <i className="bx bx-data side-menu__icon"></i>;
const MasterDataMenuBadge = (
  <span className="badge !bg-warning/10 !text-warning !py-[0.25rem] !px-[0.45rem] !text-[0.75em] ms-2">
    1
  </span>
);

const HRMenuIcon = <i className="bx bxs-user-pin side-menu__icon"></i>;
const HRMenuBadge = (
  <span className="badge !bg-warning/10 !text-warning !py-[0.25rem] !px-[0.45rem] !text-[0.75em] ms-2">
    6
  </span>
...
const FarmerMenuIcon = <i className="bx bx-leaf side-menu__icon"></i>;
const FarmerMenuBadge = (
  <span className="badge !bg-warning/10 !text-warning !py-[0.25rem] !px-[0.45rem] !text-[0.75em] ms-2">
    5
  </span>
);

const PackHouseMenuIcon = <i className="bx bx-store side-menu__icon"></i>;
const PackHouseMenuBadge = (
  <span className="badge !bg-warning/10 !text-warning !py-[0.25rem] !px-[0.45rem] !text-[0.75em] ms-2">
    6
  </span>
);

const CollectionCenterMenuIcon = (
  <i className="bx bxs-collection side-menu__icon"></i>
);
const ProcessingCenterMenuIcon = (
  <i className="bx bxs-objects-vertical-center side-menu__icon"></i>
);
const ColdStorageMenuIcon = <i className="bx bxs-inbox side-menu__icon"></i>;
const SalesMenuIcon = <i className="bx bx-money side-menu__icon"></i>;
const ReportsMenuIcon = <i className="bx bxs-report side-menu__icon"></i>;
const LogoutMenuIcon = <i className="bx bxs-exit side-menu__icon"></i>;

export const MenuItems = [
  {
    menutitle: "EVEZON INDIA - ADMIN PANEL",
    Items: [
      {
        path: "/admin/home",
        icon: HomeMenuIcon,
...

  {
    ...
    Items: [
      {
        icon: MasterDataMenuIcon,
        badgetxt: MasterDataMenuBadge,
        title: "MASTER DATA",
        type: "sub",
        active: false,
        children: [
          {
            path: "/admin/masterdata/produce",
            type: "link",
            active: false,
            selected: false,
            title: "Produce",
  ...
  //     {
  //       icon: HRMenuIcon,
  //       badgetxt: HRMenuBadge,
  //       title: "HR MANAGEMENT",
  //       type: "sub",
  //       active: false,
  //       children: [
  //         {
  //           path: "/admin/hrmanagement/phmanager",
  //           type: "link",
  //           active: false,
  //           selected: false,
  //           title: "Pack House Manager",
  //         },
  //         {
  //           path: "/admin/hrmanagement/fieldofficer",
  //           type: "link",
  //           active: false,
  //           selected: false,
  //           title: "Field Officer",
  //         },
  //         {
  //           path: "/admin/hrmanagement/marketingofficer",
  //           type: "link",
  //           active: false,
  //           selected: false,
  ...
  //         },
  //         {
  //           path: "/admin/hrmanagement/warehouseemployee",
  //           type: "link",
  //           active: false,
  //           selected: false,
  ...
  //         },
  //         {
  //           path: "/admin/hrmanagement/coldstoragemanager",
  //           type: "link",
  //           active: false,
  //           selected: false,
  ...
  //         },
  //         {
  //           path: "/admin/hrmanagement/coldstorageemployee",
  //           type: "link",
  //           active: false,
  //           selected: false,
  //           title: "Cold Storage Employee",
  //         },
  //       ],
  //     },
  //   ],
...

  {
    ...
    Items: [
      {
        icon: FarmerMenuIcon,
        badgetxt: FarmerMenuBadge,
        title: "FARMER",
        type: "sub",
        active: false,
        children: [
          {
            path: "/admin/farmers/enrollfarmer",
            type: "link",
            active: false,
            selected: false,
            title: "Enroll Farmers",
          },
          {
        ...
        children: [
          {
            ...
            active: false,
            selected: false,
            title: "RRK AGRI FARMERS MACS LTD",
          },
          {
            path: "/admin/farmers/produce",
            type: "link",
            active: false,
            selected: false,
            title: "JRR RURAL FARMERS MACS LTD",
          },
          {
            path: "/admin/farmers/financials",
            type: "link",
            active: false,
            selected: false,
            title: "BGPLM RYTHU UPSS SANGAM LTD",
          },
          {
            path: "/admin/farmers/products",
            type: "link",
            active: false,
            selected: false,
            title: " SRI MALLESWARA FPO MACS LTD",
          },
          {
            path: "/admin/farmers/pricing",
            type: "link",
          ...
          },
          {
            ...
            active: false,
            selected: false,
            title: "SRI ANNADATHA RUPSS SANGAM LTD",
          },
        ],
      },
    ],
...

  {
    ...
    Items: [
      {
        icon: PackHouseMenuIcon,
        badgetxt: PackHouseMenuBadge,
        title: "Pack House",
        type: "sub",
        active: false,
        children: [
          {
            path: "/admin/packhouse/packhouselist",
            type: "link",
            active: false,
            selected: false,
            title: "Pack House List",
          },
          {
            path: "/admin/packhouse/stockmaster",
            type: "link",
            active: false,
            selected: false,
            title: "Stock Master",
          ...
          {
            path: "/admin/packhouse/sortingandgrading",
            type: "link",
            active: false,
            selected: false,
            title: "Sorting & Grading Report",
          },
          {
            path: "/admin/packhouse/salesorder",
            type: "link",
            active: false,
            selected: false,
            title: "Sales Order",
...

  {
    ...
    Items: [
      {
        path: "/admin/collectioncenter/home",
        icon: CollectionCenterMenuIcon,
        type: "link",
        active: false,
        selected: false,
...

  {
    ...
    Items: [
      {
        path: "/admin/processingcenter/home",
        icon: ProcessingCenterMenuIcon,
        type: "link",
        active: false,
        selected: false,
...

  {
    ...
    Items: [
      {
        path: "/admin/coldstorage/home",
        icon: ColdStorageMenuIcon,
        type: "link",
        active: false,
        selected: false,
        title: "Cold Storage",
