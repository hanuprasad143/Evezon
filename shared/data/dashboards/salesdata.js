...
export class FinancialChartOverview extends Component {
  constructor(props) {
      super(props);
      ...
      this.state = {
          ...
          options: {
              ...
              colors: ["rgb(132, 90, 223)", "rgba(132, 90, 223, 0.6)", "rgba(132, 90, 223, 0.3)" ],
              plotOptions: {
                  bar: {
                      colors: {
                          ranges: [{
...
// World map
export function MapData({ setTooltipContent }) {
...
export class Salevalue extends Component {
    constructor(props) {
        super(props);
